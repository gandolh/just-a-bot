export const WORDS: readonly string[] = [
  ...
  'aware', 'badly', 'basic', 'basis', 'beach', 'began', 'begin', 'begun', 'being', 'below',
  ...
  'forum', 'found', 'frame', 'fraud', 'fresh', 'front', 'fruit', 'fully', 'funny', 'giant',
  ...
  'taste', 'taxes', 'teach', 'teeth', 'theft', 'their', 'theme', 'there', 'these', 'thick',
